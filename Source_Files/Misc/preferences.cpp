...
InfoTree network_preferences_tree()
{
	...
	root.put_attr("use_manual_remote_hub_address", network_preferences->use_manual_remote_hub_address);
	root.put_attr("manual_remote_hub_address", network_preferences->manual_remote_hub_address);
...
static void default_network_preferences(network_preferences_data *preferences)
{
	...
	preferences->use_manual_remote_hub_address = false;
	obj_clear(preferences->manual_remote_hub_address);
...
void parse_network_preferences(InfoTree root, std::string version)
{
	...
	root.read_attr("use_manual_remote_hub_address", network_preferences->use_manual_remote_hub_address);
	root.read_cstr("manual_remote_hub_address", network_preferences->manual_remote_hub_address, 255);
